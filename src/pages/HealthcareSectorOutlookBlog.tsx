...
import { AlertTriangle, TrendingUp, Activity, Building, Globe, Zap } from 'lucide-react';
...
const HealthcareSectorOutlookBlog = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-blue-100">
      <SEOHead 
        title="Healthcare Sector Outlook: India's Healthcare & Biotech Investment Themes 2025 | SIP Brewery"
