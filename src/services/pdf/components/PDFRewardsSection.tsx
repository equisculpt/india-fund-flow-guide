    ...
    <View style={styles.summaryGrid}>
      <View style={styles.summaryCard}>
        ...
        <Text style={[styles.summaryValue, { color: '#00B47B' }]}>
          ₹{rewards.totalEarned.toLocaleString('en-IN')}
        </Text>
      ...
      <View style={styles.summaryCard}>
        ...
        <Text style={[styles.summaryValue, { color: '#2E7DFF' }]}>
          ₹{rewards.referralBonus.toLocaleString('en-IN')}
        </Text>
      ...
      <View style={styles.summaryCard}>
        ...
        <Text style={[styles.summaryValue, { color: '#FFB800' }]}>
          {rewards.loyaltyPoints.toLocaleString('en-IN')}
        </Text>
      ...
      <View style={styles.summaryCard}>
        ...
        <Text style={[styles.summaryValue, { color: '#00B47B' }]}>
          ₹{rewards.cashback.toLocaleString('en-IN')}
        </Text>
      ...
      <View style={[styles.tableContainer, { marginTop: 30 }]}>
        ...
        {rewards.recentTransactions.map((transaction, index) => (
          <View key={index} style={index % 2 === 1 ? styles.tableRowAlternate : styles.tableRow}>
            ...
            <Text style={[styles.tableCellBold, { flex: 2 }]}>{transaction.type}</Text>
            <Text style={[styles.tableCellGreen, { flex: 1 }]}>
              +₹{transaction.amount.toLocaleString('en-IN')}
            </Text>
            <Text style={[styles.tableCell, { flex: 3 }]}>{transaction.description}</Text>
          </View>
        ))}
      </View>
    )}
