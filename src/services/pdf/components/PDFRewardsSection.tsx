      ...
      <View style={styles.summaryGrid}>
        <View style={styles.summaryCard}>
          ...
          <Text style={[styles.summaryValue, { color: '#00B47B' }]}>
            ₹{(rewards.totalEarned || 0).toLocaleString('en-IN', { maximumFractionDigits: 0 })}
          </Text>
        ...
        <View style={styles.summaryCard}>
          ...
          <Text style={[styles.summaryValue, { color: '#2E7DFF' }]}>
            ₹{(rewards.referralBonus || 0).toLocaleString('en-IN', { maximumFractionDigits: 0 })}
          </Text>
        ...
        <View style={styles.summaryCard}>
          ...
          <Text style={[styles.summaryValue, { color: '#00B47B' }]}>
            ₹{(rewards.cashback || 0).toLocaleString('en-IN', { maximumFractionDigits: 0 })}
          </Text>
      ...
      {rewards.pendingPayouts && rewards.pendingPayouts > 0 && (
        <View style={[styles.glanceCard, { marginTop: 25, backgroundColor: '#FEF3C7', borderColor: '#FFB800' }]}>
          ...
          <Text style={[styles.glanceValue, { color: '#FFB800' }]}>
            ₹{rewards.pendingPayouts.toLocaleString('en-IN', { maximumFractionDigits: 0 })}
          </Text>
