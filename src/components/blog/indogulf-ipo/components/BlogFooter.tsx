...
const BlogFooter = () => {
  return (
    <div className="border-t border-gray-200 pt-8">
      <p className="text-sm text-gray-500 mb-3 font-medium">Related Research Topics:</p>
      <div className="flex flex-wrap gap-3 mb-6">
        {['IPO Research 2025', 'Indogulf Cropsciences', 'Agrochemicals', 'Mainboard IPO', 'Export Business', 'Crop Protection', 'Research Analysis', 'China+1 Strategy', 'Technical Manufacturing', 'Agricultural Sector'].map((tag, index) => (
