...
const HeroRewardSection = () => {
  return (
    <div className="bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 border-2 border-blue-200 rounded-3xl p-6 lg:p-8 shadow-xl hover:shadow-blue-500/25 transition-all duration-300 max-w-2xl mx-auto lg:mx-0">
      <div className="space-y-4">
        ...
        <div className="flex items-center text-green-700 font-bold text-base lg:text-lg">
