...
const AgentDashboard = () => {
  ...
  const agentStats = {
    ...
    commissionRate: 80.0, // Updated to reflect 80% standard rate
    commissionTier: 'STANDARD' // Adding tier information
  };
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">Commission Share</CardTitle>
              <Percent className="h-4 w-4 text-purple-600" />
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold">{agentStats.commissionRate}%</div>
              <p className="text-xs text-muted-foreground">{agentStats.commissionTier} tier (90% at 5+ recruits)</p>
            </CardContent>
          </Card>
        </div>
